...
remy-admin datasources sync --source archive --concurrency 128 --priority    # the real backfill when the clock matters: priority-tier embedding at 1.5x the embedding price
