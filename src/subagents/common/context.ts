...
- Git-native deployment. Everyone works on their own branch; publishing is what advances the default branch, and that is what deploys. Pushing your own branch builds a private preview instead. Rollback is a git revert.
